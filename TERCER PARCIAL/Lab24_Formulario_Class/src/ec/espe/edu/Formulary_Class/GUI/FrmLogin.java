...
public class FrmLogin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        lblTitle.setFont(new java.awt.Font("Georgia", 2, 24)); // NOI18N
        lblTitle.setForeground(new java.awt.Color(140, 0, 0));
...
// TODO add your handling code here:
    ...
    public void User(){
     ...
     FileManager.createArrayEmployeeOfFile(employeeArray, employeesFile);
                                ...
                                useE=txtUser.getText();
                                keyE=txtPassword.getText();
                                validateUser = Validations.validateUser(employeesFile, employeeArray, useE);
				...
				if ((validateUser ==true)&& (validatePassword ==true)) {
					JOptionPane.showMessageDialog(null,"Bienvendo");
                                       FrmData frmData = new FrmData();
                                          frmData.setLocationRelativeTo(null);
